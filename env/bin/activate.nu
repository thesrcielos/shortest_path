...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/rn/eci/python-simple-experimental-algorithm-comparison/env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/rn/eci/python-simple-experimental-algorithm-comparison/env/bin/deactivate.nu'
